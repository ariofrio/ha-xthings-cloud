...
3. From the client checkout, package it:
   ...
   ```sh
   python tools/package_ha.py /path/to/core dist/ha_xthings_cloud-1.0.6.dev10-py3-none-any.whl dist/xthings_cloud.tar.gz
   ```
